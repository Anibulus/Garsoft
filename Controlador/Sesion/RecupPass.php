...
if($result ->num_rows > 0){
    ...
    try {
   		...
   		$mail->Username   = 'acumuladores.garza.stw@gmail.com';                     //SMTP username
   		$mail->Password   = 'GarzAB4t8-/';                               //SMTP password
   		$mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         //Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
   		$mail->Port       = 587;                                    //TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

    	//Recipients
    	$mail->setFrom('acumuladores.garza.stw@gmail.com', 'Garza');
	    ...
	    */
    	...
    	$mail->Subject = 'Acceso';
    	$mail->Body    = 'Ha solicitado la consulta de su clave de acceso;
